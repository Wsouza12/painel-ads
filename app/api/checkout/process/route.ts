  ...
  try {
    ...
    if (paymentMethod === "boleto") {
      ...
      try {
        ...
        boletoUrl = `https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf?erro=${encodeURIComponent(e.message || "desconhecido")}`; // Fallback com erro na URL para debug
      }
